            ...
            "metadata": {
                ...
                "dsd": {
                    ...
                    "columns": [{
                        ...
                        "id": "DIMENSION0",
                        "title": {"EN": "year"},
                        "values": {"timeList": [2014, 2013, 2012, 2011, 2010, 2009, 2008, 2007, 2006]},
                        "subject": "time"
                    }, {
                        "dataType": "code",
                        "key": true,
                        "id": "DIMENSION1",
                        "title": {"EN": "Indicator (code)"},
                        "values": {
                            "codes": [{
                                "codes": [{"code": "13020201"}, {"code": "13020202"}, {"code": "13020203"}, {"code": "13010201"}, {"code": "130201"}, {"code": "130101"}, {"code": "0301"}, {"code": "0302"}],
                        ...
                        "key": true,
                        "id": "DIMENSION2",
                        "title": {"EN": "Species (code)"},
                        "values": {
                            "codes": [{
                                "codes": [{"code": "45"}, {"code": "3"}, {"code": "34"}, {"code": "36"}, {"code": "37"}, {"code": "57"}, {"code": "43"}, {"code": "42"}, {"code": "33"}, {"code": "76"}, {"code": "38"}, {"code": "56"}, {"code": "13"}, {"code": "41"}, {"code": "25"}, {"code": "55"}, {"code": "53"}, {"code": "77"}, {"code": "92"}, {"code": "71"}, {"code": "1"}, {"code": "82"}, {"code": "72"}],
                                "idCodeList": "CountrySTAT_Fishery_products"
                            }]
                        },
                        "domain": {"codes": [{"idCodeList": "CountrySTAT_Fishery_products"}]},
                        "subject": "item"
                    }, {
                        "dataType": "text",
                        "key": false,
                        ...
                        "values": {
                            "codes": [{
                                "codes": [{"code": "0103"}, {"code": "0108"}, {"code": "0105"}],
                ...
                "title": {"EN": "PRODUCTION ET EXPORTATION DES PRODUITS HALIEUTIQUES ET DE LA PECHE"},
                "rid": "12_1302",
                "uid": "D3S_72301342456766320158096290848384418569",
                "meContent": {
                    "description": {"EN": "Evolution de production et exportation des produits halieutiques et de la peche"},
                    "resourceRepresentationType": "dataset",
                    "resourceRepresentationTypeLabel": {"EN": "Dataset"}
                },
                "languageDetails": {"EN": "FRENCH"},
                "characterSet": {
                ...
                "contacts": [{
                    "position": {"EN": "Chef de Service Statistique"},
                    "organization": {"EN": "Ministère des Ressources Halieutiques et de la Pêche"},
                    "role": "owner",
                    "contactInfo": {
                        "address": "Ministère des Ressources Halieutiques et de la Pêche BP 1699",
                        "phone": "+261324906308",
                        "emailAddress": "dgrhhajaralstat21@hotmail.fr",
                        "hoursOfService": {"EN": "08 h à 16 h"}
                    },
                    "pointOfContact": "ANDRIAMANANA Jasmin Haja Ralalasoa",
                    "organizationUnit": {"EN": "Direction de la Statistique et de la Programmation"},
                    "roleLabel": {"EN": "Owner"}
                }],
                "meAccessibility": {
                    "seDataDissemination": {
